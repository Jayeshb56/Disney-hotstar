  ...
  return (
    <div className='z-20 fixed grid grid-cols-2 bg-black h-full w-28'>
        ...
        <Link to='/signin'><img src={user} className='w-7 ml-5 mt-4 cursor-pointer' /></Link> 
          <img src={search} onClick={() => props.setSearch(!props.search)} className='w-7 ml-5 mt-9 cursor-pointer' />
          <img src={home} onClick={() => props.setMenu("home")} className='w-7 ml-5 mt-8 cursor-pointer' />
          <img src={tv} onClick={() => props.setMenu("tv")} className='w-7 ml-5 mt-8 cursor-pointer' />
          <img src={movie} onClick={() => props.setMenu("movie")} className='w-7 ml-5 mt-8 cursor-pointer' />
