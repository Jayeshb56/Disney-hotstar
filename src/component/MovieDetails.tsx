...
const MovieDetails = () => {
  ...
  return (
    ...
    <div style={{ backgroundImage: `linear-gradient(to right, rgba(0,0,0,3),rgba(0,0,0,0.1)) ,url(https://image.tmdb.org/t/p/w500${location?.state?.data?.poster_path})`, backgroundRepeat: "no-repeat", backgroundSize: "1380px 950px" }}
